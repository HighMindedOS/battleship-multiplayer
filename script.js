...
// ---------------------------
// Dummy-Implementierungen für weitere Buttons/Funktionen
// ---------------------------
function randomPlacement() { showNotification('Schiffe zufällig platziert! (Demo)', 'info'); }
function clearBoard() { showNotification('Spielfeld geleert! (Demo)', 'info'); }
function rotateShip() { showNotification('Schiff gedreht! (Demo)', 'info'); }
function setPlayerReady() { showNotification('Bereit! (Demo)', 'info'); }
function surrenderGame() { showNotification('Aufgegeben! (Demo)', 'warning'); }
